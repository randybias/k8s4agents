# Kubernetes Troubleshooter Skill Specification
...
The skill SHALL provide executable scripts for common diagnostic operations that can be run directly without modification.
